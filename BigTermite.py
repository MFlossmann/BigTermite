...
class Big_Termite:
    def __init__(self, top=None):
        ...
        self.Text1.place(relx=0.37, rely=0.17, relheight=0.07, relwidth=0.22)
        self.Text1.configure(background="white")
        self.Text1.configure(font="TkTextFont")
        self.Text1.configure(selectbackground="#c4c4c4")
        self.Text1.configure(width=125)
        self.Text1.configure(wrap=WORD)

        self.Label1 = Label(self.Frame1)
        self.Label1.place(relx=0.42, rely=0.12, height=19, width=66)
        self.Label1.configure(text='''Time''')
        ...
        self.ExportChecker.place(relx=0.62, rely=0.24, relheight=0.05
                                 , relwidth=0.12)
        ...
        self.Label2.configure(text='''Big Termite, Copyright: Floßmann 2018''')
